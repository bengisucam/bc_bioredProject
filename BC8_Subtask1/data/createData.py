...
class Relation:
    def __init__(self, id1, id2, type, is_novel, is_relation, candidate_sentences):
        self.id1 = id1
        self.id2 = id2
        self.type = type
...
def createDocumentEntitiesAndRelations(in_pubtator_path):
    ...
    with open(os.path.join(os.getcwd(), in_pubtator_path), 'r', encoding='utf8') as pub_reader:
        ...
        for line in pub_reader:
            ...
            # get the relation information
                ...
                entity1, entity2 = line_items[2], line_items[3]
                is_relation_novel = True if line_items[-1].strip() == "Novel" else False
                #create True relation pairs
                relationObject = Relation(id1=entity1, id2=entity2, type=relation_type, is_relation=True,
    ...
    for doc_id in all_entities:
        ...
        for pair in possible_pairs:
            e1, e2 = pair[0], pair[1]
            if not [rel for rel in true_relations if rel.id1 == e1 and rel.id2 == e2]:
                false_relation = Relation(id1=e1, id2=e2, is_relation=False, type=None, is_novel=False,
...
if __name__ == '__main__':
    ...
    for doc_id in normalized_doc_dict:
        ...
        for relation in relation_pairs:
            e1 = [e for e in entities if e.id == relation.id1][0]
            e2 = [e for e in entities if e.id == relation.id2][0]
            ...
            relation.candidate_sentences = candidate_sentences
            # now find the sdp of the candidate sentences
