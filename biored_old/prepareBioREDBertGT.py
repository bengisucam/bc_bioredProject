        ...
        for annotation in text_instance.annotations:
            ...
            for _tmp_text_instance in _tmp_text_instances:
                if _tmp_text_instance.offset <= annotation.position and \
                        (annotation.position + annotation.length) - _tmp_text_instance.offset <= len(
                    _tmp_text_instance.text):
...
def convert_iob2_to_tagged_sent(
    ...
    new_in_neighbors_list = ['|'.join([str(i + token_offset) for i in set(neighbors)]) for neighbors in
                             new_in_neighbors_list]
    ...
    with open(out_bert_file, 'w', encoding='utf8') as bert_writer:
        ...
        if is_test_set:
            if not has_novelty:
                ...
                bert_writer.write(
                    'pmid\tid1\tid2\tis_in_same_sent\tmin_sents_window\tsentence\tin_neighbors\tlabel\tnovelty\n')
...
if __name__ == '__main__':
    ...
    in_data_dir = 'C://Users//B3LAB//Desktop//thesis//BioRED//'
    out_data_dir = 'C://Users//B3LAB//Desktop//thesis//BioRED//processed//all//'
    re_id_spliter_str = r'\,'
    ...
    out_data_dir = 'C://Users//B3LAB//Desktop//thesis//BioRED//processed//'
    re_id_spliter_str = r'\,'
    normalized_type_dict = {'SequenceVariant': 'GeneOrGeneProduct'}
